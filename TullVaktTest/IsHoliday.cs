...
namespace TullVaktTest
{
    ...
    public class IsHoliday
    {
        ...
        {
            var car = new Vehicle();
            var isHoliday = Guard.IsHoliday(new DateTime(2015,05,01));
        ...
        {
            var car = new Vehicle();
            var isHoliday = Guard.IsHoliday(new DateTime(2011, 01, 01));
            Assert.IsTrue(isHoliday);
        }
        ...
        {
            var car = new Vehicle();
            var isHoliday = Guard.IsHoliday(new DateTime(2018, 01, 06));
            Assert.IsTrue(isHoliday);
        }
        ...
        {
            var car = new Vehicle();
            var isHoliday = Guard.IsHoliday(new DateTime(2001, 06, 06));
            Assert.IsTrue(isHoliday);
        }
        ...
        {
            var car = new Vehicle();
            var isHoliday = Guard.IsHoliday(new DateTime(1988, 12, 25));
            Assert.IsTrue(isHoliday);
        }
        ...
        {
            var car = new Vehicle();
            var isHoliday = Guard.IsHoliday(new DateTime(2007, 12, 26));
            Assert.IsTrue(isHoliday);
        }
